...
import { faHeart, faUser, faHome, faBars, faClose} from '@fortawesome/free-solid-svg-icons'
            ...
            <div className={styles.nav}>
                ...
                <ul className={styles.nav_desktop}>
                    <li className={styles.nav_list}>
                        <FontAwesomeIcon className={styles.nav_icon} icon={faHome}/>
                        <NavLink className={`${styles.nav_links} ${({isActive}) => isActive ? "active": ""}`} to="/characters">
                            Characters
                        </NavLink>
                    </li>
                    ...
                    <li className={styles.nav_list}>
                        ...
                        <NavLink className={`${styles.nav_links} ${({isActive}) => isActive ? "active": ""}`}  to="/about">
                            About
                        </NavLink>
                    </li>

                    <li className={styles.nav_list}>
                        <FontAwesomeIcon className={styles.nav_icon} icon={faHeart}/>
                        <NavLink className={`${styles.nav_links} ${({isActive}) => isActive ? "active": ""}`}  to="/favorites">
                            Favorites {`(${initialFavorites?.length})`}
                        </NavLink>
                    </li>

                    <li className={styles.nav_list}>
                        <img src={profile_image} className={styles.profile_image} alt="profile img"/>
