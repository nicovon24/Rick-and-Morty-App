                    ...
                    <div className={styles.about_text}>
                        ...
                        <figure className={styles.about_techno}>
                            ...
                            <div>
                                ...
                                <img src={require("../../assets/icons/c_sharp.png")} alt="c sharp img"/><br></br>
                            </div>
                            <div>
                        ...
                        <figure className={styles.about_social_media}>
                            ...
                            <a href="https://www.linkedin.com/in/nicol%C3%A1s-von-muhlinen-6a7727208/" target={"_blank"} rel="noreferrer">
                                <img src={require("../../assets/icons/linkedin.png")} alt="linkedin img"
                            /></a>
                           <a href="https://github.com/nicovon24" target={"_blank"} rel="noreferrer">
                                <img src={require("../../assets/icons/github.png")} alt="github img"/>
                           </a>
                            <img src={require("../../assets/icons/cv.png")} alt="cv img" onClick={()=>window.open(PdfFile)}/>
                        </figure>
